...
const actions = {
        ...
        async res => {
          if (res.data) {
            if (res.code === 200) {
              ...
              paramsOri.runPlatform = env.loginParam.runPlatform
  ...
  // logout ({commit, state}, env.loginParams, res) {
  ...
  reLogin ({
    ...
    if (aH5Token) {
      ...
      var params = {}
      params.sdkVer = env.loginParam.sdkVer
      params.sdkType = env.loginParam.sdkType
      params.runPlatform = env.loginParam.runPlatform
